...
if($_POST['pwd'])					{$pwd					=	$db->filter($_POST['pwd']);}
if($_POST['bbs_view_edit'])	{$bbs_view_edit	=	$db->filter($_POST['bbs_view_edit']);}
...
<section class="bbs-write-con">
	<article class="bbs-write-tbl-box">
		...
		<tr>
			...
			<td><input type="text" class="write-input" autofocus="" name="subject" value="<?=$bbs_stat->subject?>"></td>
		</tr>
		<tr>
			<th scope="row"><span class="essential-icon">*</span> <?=$title_name?></th>
			<td><input type="text" class="write-input" name="name" value="<?=$bbs_stat->name?>"></td>
		</tr>
		...
		<tr>
			...
			<td>
				<fieldset class="input-check">
					<span>
						<input type="radio" name="secret" id="radio1" value="" <? if(empty($bbs_stat->secret)){echo "checked"; } ?>>
						<label for="radio1"><?=$title_pu?></label>
					</span>
					<span>
						<input type="radio" name="secret" id="radio2" value="y" <? if($bbs_stat->secret=="y"){echo "checked"; } ?>>
						<label for="radio2"><?=$title_pri?></label>
					</span>
				</fieldset>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<? if($bbs_stat->sbbs_file){ ?>
					&nbsp;<?=$bbs_stat->bbs_file?>&nbsp;<input type="checkbox" name="imdel1" value="y"><?=$title_del?><br>
				<? } ?>
				<input type="file" name="bbs_file" class="write-input" id="file">
			</td>
		</tr>
		<? } else { ?>
		...
		<tr>
			...
			<td>
				<? if($bbs_stat->sbbs_file){ ?>
					&nbsp;<?=$bbs_stat->sbbs_file?>&nbsp;<input type="checkbox" name="imdel1" value="y"><?=$title_del?><br>
				<? } ?>
				<input type="file" name="bbs_file" class="write-input" id="file">
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<?if($bbsf){ ?>
					&nbsp;<?=$bbsf?>&nbsp;<input type="checkbox" name="imdel<?=$i?>" value="y"><?=$title_del?><br>
				<? } ?>
				<input type="file" name="bbs_file<?=$i?>" class="write-input"/>
			</td>
		</tr>
		<? } ?>	
		<? } ?>
	...
	<div class="cm-btn-controls">
		...
		<a href="<?=$_SERVER['PHP_SELF']?>" class="btn-style02"><?=$title_cancel?></a>
	</div>
