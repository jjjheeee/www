...
if($_GET['coment_del'])				{$coment_del			=	$db->filter($_GET['coment_del']);}
if($_GET['bbs_view_del'])			{$bbs_view_del			=	$db->filter($_GET['bbs_view_del']);}
if($_GET['bbs_view_edit'])			{$bbs_view_edit		=	$db->filter($_GET['bbs_view_edit']);}
if($_GET['bbs_view_secr'])			{$bbs_view_secr		=	$db->filter($_GET['bbs_view_secr']);}
