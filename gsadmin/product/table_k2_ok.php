...
if($mode=="write"){
	...
	$tools->alertJavaGo("입력 하였습니다.","table_k2.php?code=".$code);
...
if($mode=="edit"){
	...
	$i=1;
	$rs2 = $db->select("cs_goods_k_tableh","where code='$code' and cate='2' and keyidx='$idx' order by num asc");
	...
	$tools->alertJavaGo("수정 하였습니다.","table_k2.php?code=".$code);
...
if($mode=="del"){
	...
	$tools->alertJavaGo("삭제 하였습니다.","table_k2.php?code=".$_GET[code]);
