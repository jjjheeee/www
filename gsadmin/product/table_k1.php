...
<div class="col-md-12" >
	...
	<h4 class="page-header">Technical Specifications (국문)</h4>
	...
	<tr>
		<td colspan="2" class="text-center">
			<button type="button" onclick="location.href='table_k1_write.php?code=<?=$code?>';" class="btn btn-primary btn-sm">등록하기</button>
		</td>
	</tr>
	</tbody>
	</table>
						...
						<?
						$rs = $db->select("cs_goods_k_tablew","where code='$code' and cate='1' order by ranking asc, idx asc");
								...
								<div class="scroll-object-box">
									<table class="equipment-view-tbl scroll-object">
										<tbody>
											...
											<?
											$rs2 = $db->select("cs_goods_k_tableh","where code='$code' and cate='1' and keyidx='$row->idx' order by num asc");
						...
						<table class="table">
							<tr>
								<td class="text-center">
									<button type="button" class="btn btn-primary" onClick="location.href='table_k1_edit.php?idx=<?=$row->idx?>&code=<?=$code?>';">수정</button>
...
function dele(text){
	...
	if(ans==true){
		location.href="table_k1_ok.php?code=<?=$code?>&mode=del&idx="+text;
	}
