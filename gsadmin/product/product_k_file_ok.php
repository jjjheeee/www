...
if($mode=="write"){
	...
	$db->insert("cs_goods_k_file","code='$code', title='$title', bbs_file='$file_name', sbbs_file='$sfile_name', ranking='$ranking'");

	$tools->alertJavaGo("입력 하였습니다.","product_k_file.php?code=".$code);
...
// 파일업로드 
	$bbs_data_stat = $db->object("cs_goods_k_file", "where idx=$idx", "bbs_file, sbbs_file");
	...
	$db->update("cs_goods_k_file","title='$title', bbs_file='$file_name', sbbs_file='$sfile_name', ranking='$ranking' where idx='$idx'");

	$tools->alertJavaGo("수정 하였습니다.","product_k_file.php?code=".$code);
...
if($mode=="del"){
	...
	$bbs_stat = $db->object("cs_goods_k_file", "where idx = $idx", "bbs_file");

	if($bbs_stat->bbs_file){ 
		//@unlink("../../data/bbsData/".$bbs_stat->bbs_file); 
	}
	
	$db->delete("cs_goods_k_file","where idx='$idx'");

	$tools->alertJavaGo("삭제 하였습니다.","product_k_file.php?code=".$_GET[code]);
