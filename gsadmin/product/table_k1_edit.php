...
<div class="col-md-12" >
	...
	<form method="post" action="table_k1_ok.php" name="form">
	...
	<input type="hidden" name="mode" value="edit">
						...
						<div class="prd-cm-table">
							...
							<textarea name="title" class="form-control" style="height:150px;"><?=$row->title?></textarea>
							</p> 
						...
						<table class="table">
							<tr>
								<td class="text-center">
									...
									<a href="table_k1.php?code=<?=$code?>" class="btn btn-default">목록</a>
								</td>
							</tr>
						</table>
	</form>
