...
$row = $db->object("cs_goods_k_file","where idx='$idx'");
?>
...
<div class="col-md-12" >
	...
	<form method="post" action="product_k_file_ok.php" name="form" enctype="multipart/form-data">
						...
						<table class="table">
							<tr>
								<td class="text-center">
									...
									<a href="product_k_file.php?code=<?=$code?>" class="btn btn-default">목록</a>
								</td>
							</tr>
						</table>
	</form>
