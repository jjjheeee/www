...
<div class="col-md-12" >
	...
	<tr>
		<td colspan="2" class="text-center">
			<button type="button" onclick="location.href='table_k2_write.php?code=<?=$code?>';" class="btn btn-primary btn-sm">등록하기</button>
		</td>
	</tr>
	</tbody>
	</table>
						...
						<?
						$rs = $db->select("cs_goods_k_tablew","where code='$code' and cate='2' order by ranking asc, idx asc");
						...
						<table class="table">
							<tr>
								<td class="text-center">
									<button type="button" class="btn btn-primary" onClick="location.href='table_k2_edit.php?idx=<?=$row->idx?>&code=<?=$code?>';">수정</button>
...
function dele(text){
	...
	if(ans==true){
		location.href="table_k2_ok.php?code=<?=$code?>&mode=del&idx="+text;
	}
