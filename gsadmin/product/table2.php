...
<div class="col-md-12" >
	...
	<h4 class="page-header">Accessories / Option</h4>
	...
	<tr>
		<td colspan="2" class="text-center">
			<button type="button" onclick="location.href='table2_write.php?code=<?=$code?>';" class="btn btn-primary btn-sm">등록하기</button>
		</td>
	</tr>
	</tbody>
	</table>
						...
						<?
						$rs = $db->select("cs_goods_tablew","where code='$code' and cate='2' order by ranking asc, idx asc");
								...
								<div class="scroll-object-box">
									<table class="equipment-view-tbl scroll-object">
										<tbody>
											...
											<?
											$rs2 = $db->select("cs_goods_tableh","where code='$code' and cate='2' and keyidx='$row->idx' order by num asc");
						...
						<table class="table">
							<tr>
								<td class="text-center">
									<button type="button" class="btn btn-primary" onClick="location.href='table2_edit.php?idx=<?=$row->idx?>&code=<?=$code?>';">수정</button>
...
function dele(text){
	...
	if(ans==true){
		location.href="table2_ok.php?code=<?=$code?>&mode=del&idx="+text;
	}
