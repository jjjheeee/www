		...
		<section id="mainVideo" class="section">
			<article class="background-video-wrapper">
				<div class="background-video">
					<div id="playerMain" data-code="hYwa5TStSwo"></div> <!-- 유투브 코드값 -->
				</div>
					...
					<div class="main-visual-txt-con">
						<div class="main-visual-txt-box area-box">
							<div class="main-visual-txt-inner">
								...
								<div class="main-visual-btn up-effect-txt"><a href="" class="cm-button-style06 clearfix main-visual-more-btn"><span>VISIT ISSCA</span><i class="xi-trending-flat arrow"></i></a></div>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="main-visual-txt-con">
						<div class="main-visual-txt-box area-box">
							<div class="main-visual-txt-inner">
								...
								<div class="main-visual-btn up-effect-txt"><a href="" class="cm-button-style06 clearfix main-visual-more-btn"><span>VISIT ESFOMI</span><i class="xi-trending-flat arrow"></i></a></div>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="inner-area">
						<div class="menu-con">
							...
							<ul class="menu-list">
								...
								<li><a href="<?=$site_url?>/stemcell/solution.php"><span>Stem Cell Total Solution<i class="xi-long-arrow-right"></i></span></a></li>
			...
			<section class="cm-tab-container-JS" data-scroll="">
				<article class="play-video-tab-content cm-tab-content-wrapper-JS">
					<div class="sub-tab-con video-con-01" id="tabCon01" data-video="0">
						...
						<div class="play-video-txt start">
							<div class="area-box">
								<strong class="cm-word-split-JS up-effect-txt-02" data-splitting>Company Introduction Video</strong>
								<div class="txt up-effect-txt-02">
									<div class="effect-inner">
										<p>N-BIOTEK provide Stem Cell Total Solution including Bio clean room construction, <br class="pc-br">Stem Cell equipment installation, Technology transfer, Consumables, and Stem Cell Cosmetics.</p>
										<p>We are completely ready to take care of your health, beauty and anti-aging. <br>We will lead regenerative medicine with stem cell therapy, and very advanced biotechnology.</p>
						...
						<div class="play-video-bg video-bg-01" style="background:url(/images/main/play_video_bg01.jpg) no-repeat 50% 50%"></div>
					</div>
					<div class="sub-tab-con video-con-02" id="tabCon02" data-video="1">
						...
						<div class="play-video-txt">
							<div class="area-box">
								...
								<div class="txt">
									<p>Congratulations on the 20th anniversary of N-BIOTEK!</p>
									<p>Since March 13th  2000, We have been growing along with our partners.<br>
									Thank you all of N-BIOTEK partners and hope we can keep growing with you!</p>
								</div>
					...
					<div class="sub-tab-con video-con-03" id="tabCon03" data-video="2">
						...
						<div class="play-video-txt">
							<div class="area-box">
								...
								<div class="txt">
									<p>ISSCA focuses on developing stem cell application, <br class="pc-br">getting government approval, and finally spreading stem cell treatment. <br>ISSCA will definitely play the key role in leading stem cell therapy & technology.</span>
									<p>ISSCA has wide range of activity : Conference, Symposium, Seminar, Training, <br class="pc-br">Demonstration therapy, Clinical trial presentation.</span>
				...
				<aside class="play-video-tab">
					<div class="play-video-tab-list cm-tab-list-JS scroll-object" data-scroll="">
						<ul class="clearfix">
							<li class="selected up-effect-txt"><a href="#tabCon01" class="video-01 effect-inner" data-video="0">Company Introduction Video<em>01</em></a></li>
							<li class="up-effect-txt"><a href="#tabCon02" class="video-02 effect-inner" data-video="1">20th Anniversary Video<em>02</em></a></li>
