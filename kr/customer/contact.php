...
<? include $_SERVER["DOCUMENT_ROOT"].$site_directory."/include/top.php"; ?>
	<section class="contact-page">
			...
			<div class="contact-info-wrapper">
				<div class="inner">
					...
					<div class="info-list">
						<dl>
							<dt>주소</dt>
							<dd>(14502) 대한민국 경기도 부천시 평천로 655, 테크노파크 402-803</dd>
						</dl>
						<dl>
							<dt>이메일</dt>
		...
		<article class="contact-item" data-scroll="fade-up" id="rndLocation">
			...
			<div class="contact-info-wrapper">
				<div class="inner">
					<h3>엔바이오텍 <br class="pc-br" />R&D 센터</h3>
					<div class="info-list">
						<dl>
							<dt>주소</dt>
							<dd>(14449) 대한민국 경기도 부천시 석천로 397, 테크노파크 쌍용3차 104-706</dd>
						</dl>
						<!--<dl>
							<dt>E-MAIL</dt>
			...
			<div class="contact-info-wrapper">
				<div class="inner">
					...
					<div class="info-list">
						<dl>
							<dt>주소</dt>
							<dd>(14501) 대한민국 경기도 부천시 석천로 345, 테크노파크 304-805</dd>
						</dl>
						<dl>
							<dt>전화</dt>
							<dd>032-234-1016</dd>
