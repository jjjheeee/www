			...
			<article class="main-quick-menu kwicks">
				<div class="main-quick-item item-01 scroll-object">
					...
					<div class="inner-area">
						<div class="tit-con">
							<strong class="txt-01">생명과학 장비</strong>
							<p class="txt-02">세포 배양 및 일반 연구소를 위한 최고의 솔루션<br>다양한 용량과 선택 가능</p>
						</div>
						<div class="menu-con">
							<strong class="menu-tit">실험장비</strong>
							<ul class="menu-list">
								<li><a href="<?=$site_url?>/equipment/equipment_list.php?part_idx=1"><span>CO<sub>2</sub> 배양기<i class="xi-long-arrow-right"></i></span></a></li>
								<li><a href="<?=$site_url?>/equipment/equipment_list.php?part_idx=2"><span>진탕배양기<i class="xi-long-arrow-right"></i></span></a></li>
