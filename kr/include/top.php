<script>
	<? if ( $page_section == "nbiotek" ) { ?>	//  1번째  대메뉴 인덱스
		dep1 = 1
	<? }else if ( $page_section == "ribon" ) { ?>	//  2번째 대메뉴 인덱스
		dep1 = 2
	<? }else if ( $page_section == "reproduction" ) { ?>	//   3번째  대메뉴 인덱스
		dep1 = 3
	<? }else if ( $page_section == "stemcell" ) { ?> //  4번째  대메뉴 인덱스
		dep1 = 4	
	<? }else if ( $page_section == "equipment" ) { ?> //  6번째  대메뉴 인덱스
		dep1 = 6	
	<? }else if ( $page_section == "customer" ) { ?> // 7번째  대메뉴 인덱스
		dep1 = 7	
	<? }else { ?>
		dep1 = 0	
	<? } ?>
					...
					<div class="cm-top-menu clearfix">
						...
						<div class="menu-location location1 cm-drop-menu-box-JS" data-drop-event="click">
							...
							<ul class="location-menu-con cm-drop-list-JS">								
								...
								<li><a href="<?=$site_url?>/ribon/ribon.php">리본스템</a></li>
								<li><a href="<?=$site_url?>/reproduction/solution.php">첨단 재생 의료</a></li>
								<li><a href="<?=$site_url?>/stemcell/about.php">줄기세포</a></li>
								<li><a href="https://esfomi.co.kr/">애스포미</a></li>
								<li><a href="<?=$site_url?>/equipment/equipment_intro.php">연구 장비</a></li>								
