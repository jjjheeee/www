		...
		<div id="headerInnerWrap">
					...
					<div class="header-util-box">
						...
						<div class="header-lang-box">
							<ul class="header-lang-list">
								<li><a href="<?=$site_host?>/kr/">KOR</a></li>
								<li class="cur"><a href="<?=$site_host?>/en/">ENG</a></li>
							</ul>
						</div>

						<!-- <div class="header-lang cm-drop-menu-box-JS" data-drop-event="click">
							<button class="lang-open-btn cm-drop-open-btn-JS"><strong>ENG</strong><span class="arrow"><i class="xi-angle-down-min"></i></span></button>
			...
			<nav id="gnb" class="total-menu">
				...
				<ul class="clearfix">
					...
					<li class="gnb2">
						<a href="<?=$site_url?>/nbiotek/about.php"><span>N-BIOTEK Group</span></a>
						<div class="gnb-2dep">
							<ul>
								<? include $_SERVER["DOCUMENT_ROOT"].$site_directory."/include/menu_nbiotek_t(240325).php"; ?>
							</ul>
						</div>
					</li>
					<li class="gnb3">
						<a href="<?=$site_url?>/equipment/equipment_intro.php"><span>Lab Equipment</span></a>
						<div class="gnb-2dep">
							<ul>
					...
					<li class="gnb4">
						<a href="<?=$site_url?>/stemcell/about.php"><span>Stem Cell</span></a>
						<div class="gnb-2dep">
							<ul>
			...
			<div class="gnb-navigation-wrapper">
				<div class="gnb-navigation-inner">
					<ul id="navigation" data-menu-clone="false">
						...
						<li class="gnb3">
							<a href=""><span>Lab Equipment</span></a>
							<div class="gnb-2dep">
								<ul>
									<? include $_SERVER["DOCUMENT_ROOT"].$site_directory."/include/menu_equipment.php"; ?>
								</ul>
