			...
			<div class="area-box clearfix">
				...
				<div class="footer-left-con">
					<ul class="foot-menu clearfix">
						<li><a href="<?=$site_url?>/etc/privacy.php" class="cm-modal-open-btn">Privacy policy</a></li>
						<li><a href="<?=$site_host?>/images/content/N-BIOTEK_PRODUCT_CATALOG_VOL_18.pdf" download>Catalogue Download</a></li>
						<li><a href="<?=$site_url?>/customer/contact.php">Contact Us</a></li>
					</ul>
				</div>
				<!-- 푸터상단 오른쪽 -->
				...
				<article class="footer-left-con">
					<div class="footer-address-info-box">
						<div class="footer-address-list">
							<dl>
								<dt>Address</dt>
								<dd>N-BIOTEK, INC. l 402-803 Technopark, 655, Pyeongcheon-ro, Bucheon-si, Gyeonggi-do, Korea 14502</dd>
							</dl>
						</div>
						<div class="footer-address-list">
							<dl>
