...
?>
	...
	<section class="equipment-list-page scroll-object" data-scroll="fade-up" data-scroll-delay="200">
		...
		$rscnt = $db->cnt("cs_goods","where display='1' and part_idx='$rowp->idx' $query");
		if($rscnt>0){
		?>

		<div class="equipment-cate-sec">
			<h3 class="list-title"><?=$rowp->part_name?></h3>
			<ul class="equipment-list">
				
				<?
				$rs = $db->select("cs_goods","where display='1' and part_idx='$rowp->idx' $query order by ranking asc, idx desc");
